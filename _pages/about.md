...
<a class="carousel-control-next" href="#image-slider" role="button" data-slide="next">
    <span aria-hidden="true">
        <svg width="40" height="40" fill="black" viewBox="0 0 16 16">
        <path d="M4.646 14.354a.5.5 0 0 1 0-.708L10.293 8 4.646 2.354a.5.5 0 1 1 .708-.708l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708 0z"/>
        </svg>
    </span>
...
<div class="news">
  ...
  <table class="table table-sm table-borderless">
    <tr>
        ...
        <td> Two papers are accepted at <b>INTERSPEECH</b> 2026! 🎉 </td>
    </tr>
    <tr>
